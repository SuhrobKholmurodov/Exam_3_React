...
const Home = () => {
  ...
  return (
    <>
      <hr className="text-[white] pt-[-5px]" />
      <div>
        <Swiper
          spaceBetween={30}
          centeredSlides={true}
            ...
            <div className="dark:bg-[#2c3153] text-[white] bg-grr">
              <div className="pt-[20px] pb-[200px] flex justify-between w-[90%] m-auto items-center">
                <div className="flex justify-star flex-col text-start">
                  <p className="text-[35px] sm:text-center sm:mt-[60px] sm:text-[19px] mt-[20px]">
                    {t("first.text1")}
                  </p>
                  <p className="text-white sm:text-center sm:text-[14px] mt-[15px] text-[20px] mb-[40px]">
                    {t("first.text2")}
                  </p>
      ...
      <section className="dark:bg-[#2c3153] pb-[20px] w-full flex-wrap dark:text-[white]">
        <div className="flex gap-[60px] sm:flex-wrap w-[90%] m-auto pt-[30px]">
          <div>
            <p className="text-[33px] sm:text-center sm:text-[22px] font-[700]">
              {t("second.text1")}
            </p>
            <p className="text-[grey] sm:text-center dark:text-[white] mt-[19px]">
              {t("second.text2")}
            </p>
          </div>
      ...
      <hr className="text-[white]" />
      <section className="dark:bg-[#2c3153] w-full dark:text-[white] pb-[20px]">
        <div className="flex sm:flex-col items-center justify-between w-[90%] m-auto pt-[30px] pb-[30px]">
        ...
        <div className="w-full">
          <div className="flex flex-wrap sm:justify-center gap-[10px] w-[90%] m-auto justify-between">
      ...
      <hr className="text-[white]" />
      <section className="dark:bg-[#2c3153] w-full dark:text-[white]">
        <div className="flex items-center sm:flex-col justify-between w-[90%] m-auto pt-[30px] pb-[30px] ">
          <p className="text-[33px] font-[600]">{t("fourth.text1")}</p>
          <img className="sm:hidden" src={twoBtn} alt="" />
        </div>
        <div className="">
          <div className="flex flex-wrap sm:justify-center sm:gap-[20px] w-[90%] m-auto justify-between">
            <div>
              <Card2
                img={onemen}
                p1={t("fourth.text2")}
        ...
        <div className="mt-[40px] pb-[30px] sm:justify-start sm:ml-[70px] flex justify-center items-center">
          <Button
            text={t("fourth.btn2")}
      ...
      <hr className="text-[white]" />
      <section className="dark:bg-[#2c3153] w-full pb-[40px]">
        <div className="w-[90%] sm:flex-col gap-[10px] pt-[20px] m-auto flex justify-between">
          <div className="sm:hidden">
            <Card3
              bg={"rgba(59, 185, 109, 1"}
              p={"20px"}
          ...
          <div>
            <div className="grid grid-cols-2 gap-[10px] sm:grid-cols-1">
              <Card3
      ...
      <section className="dark:bg-[#2c3153] pt-[30px]">
        <p className="pb-[40px] sm:text-center dark:text-[white] w-[90%] flex items-start m-auto text-[30px] font-[700]">
          {t("six.text1")}
        </p>
        <div className="flex flex-wrap sm:gap-[30px] justify-between w-[90%] m-auto">
      ...
      <section className="dark:bg-[#2c3153] pb-[20px] flex-wrap dark:text-[white]">
        <div className="grid grid-cols-2 sm:grid-cols-1 gap-[60px] w-[90%] m-auto pt-[30px]">
          <div>
            <p className="text-[grey] sm:text-center dark:text-[white] mb-[25px] mt-[19px]">
              {t("second.text2")}
            </p>
            <div className="sm:flex sm:justify-center">
              <Button
      ...
      <section className="dark:bg-[#2c3153] pb-[30px]">
        <p className="text-[30px] font-[600] dark:text-[white] sm:text-center w-[90%] m-auto pb-[30px] pt-[20px]">
          {t("seven.a1")}
        </p>
        <div className="start flex-wrap sm:gap-[20px] sm:justify-center flex w-[90%] m-auto justify-between">
          <div>
            <img
              width={"230px"}
      ...
      <section className="dark:bg-[#2c3153]">
        <p className="w-[90%] sm:text-center font-[600] pt-[30px] pb-[30px] m-auto text-[30px] dark:text-[white]">
          {t("eight.p1")}
        </p>
      </section>
      <hr className="text-[white]" />
      <section className="dark:bg-[#2c3153] pt-[30px]">
        <div className="grid grid-cols-2 sm:grid-cols-1 gap-[20px] dark:bg-[#2a327b] dark:text-[white]  rounded-[10px] justify-between w-[90%] bg-grey m-auto p-[20px]">
          ...
          <div className="pt-[30px]">
            <p className="text-[30px] sm:text-center font-[700]">
              {t("nine.p1")}
            </p>
            <p className="h-[4px] w-[80px] sm:ml-[115px] bg-grr"></p>
            <p className="mt-[10px] sm:text-center">{t("nine.p10")}</p>
            <div className="flex items-center sm:flex-col justify-between">
              <div className="flex flex-col sm:text-center sm:pt-[10px] justify-between h-[310px]">
                <div>
      ...
      <section className="dark:bg-[#2c3153] dark:text-[white] pt-[50px]">
        <p className="text-[30px] font-[700] w-[90%] sm:text-center m-auto">
          {t("ten.p1")}
        </p>
      </section>
      <section className="dark:bg-[#2c3153]">
        <div className="w-[90%] m-auto sm:grid-cols-2 grid items-center pb-[30px] grid-cols-6 gap-[70px] pt-[40px]">
          <img src={samsung} alt="" />
          <img src={samsung} alt="" />
          <img src={samsung} alt="" />
      ...
      <section className="dark:bg-[#2c3153] dark:text-[white] pt-[30px] pb-[20px]">
        <p className="text-[30px] sm:text-center font-[700] w-[90%] m-auto">
          {t("ten.p2")}
        </p>
      </section>
      <section className="dark:bg-[#2c3153]">
        <div className="w-[90%] sm:flex-col sm:gap-[20px] m-auto flex justify-between pb-[50px] pt-[30px]">
          <img src={diplom} alt="" />
          <img src={diplom} alt="" />
          <img src={diplom} alt="" />
          <img src={diplom} alt="" />
      ...
      <section>
        <div className="ss flex justify-between w-[100%]">
          <div className="bg-[black] sm:text-center sm:gap-[10px] flex flex-col justify-between p-[90px] text-[white] w-[410px]">
            <p>{t("last.p1")}</p>
            <div>
              <p>{t("last.p2")}</p>
              <p>{t("last.p3")}</p>
