  ...
  return (
    <div className="start">
      <div className="dark:bg-[#2c3153] pt-[10px] dark:text-[white]">
        ...
        <p className="w-[90%] sm:text-[25px] sm:text-center m-auto pb-[30px] text-[30px] font-[700]">
          Направления нашей работы
        </p>
      </div>
      <div className="dark:bg-[#2c3153] text-[white]">
        <div className="grid w-[90%] sm:grid-cols-1 sm:flex sm:flex-col sm:items-center m-auto pt-[30px] gap-[20px] pb-[70px] grid-cols-4">
      ...
      <section className="dark:bg-[#2c3153] dark:text-[white]">
        <p className="w-[90%] sm:text-center m-auto pb-[30px] text-[30px] font-[700]">
          Запись на приём
        </p>
      </section>
      <section className="dark:bg-[#2c3153] dark:text-[white]">
        <div className="flex w-[90%] sm:flex-col sm:items-center sm:gap-[30px] m-auto items-end pb-[30px] justify-between">
        ...
        <div className="flex sm:flex-col sm:text-center text-[14px] gap-[6PX] w-[90%] m-auto pb-[50px]">
