  ...
  return (
    <div className="start">
      <div className="dark:bg-[#2c3153] pt-[10px] dark:text-[white]">
        <div className="flex w-[90%] m-auto pb-[20px]">
      ...
      >
        <SwiperSlide>
          <div className="dark:bg-[#2c3153] dark:text-[white]">
            <div className="three flex sm:items-center sm:flex-col justify-between w-[90%] m-auto">
        ...
        <SwiperSlide>
          <div className="dark:bg-[#2c3153] dark:text-[white]">
            <div className="three sm:items-center sm:flex-col flex justify-between w-[90%] m-auto">
              <div className="second flex items-start h-[530px] pt-[30px]">
                <div>
                  <Card2
                    img={onemen}
      ...
      <div className="dark:bg-[#2c3153] pb-[30px] pt-[40px]">
        <div className="grid rounded-[15px] dark:bg-[black] grid-cols-2 bg-[black] w-[90%] m-auto text-[white]">
          <div className="w-[90%] m-auto flex justify-between">
            <div>
              <p className="text-[30px] sm:text-[20px] sm:pt-[10px] font-[700] pb-[20px]">
                {t("doc1.p1")}
              </p>
              <p>{t("doc1.p2")}</p>
              <br />
              ...
              />
              <br />
              <div className="flex sm:flex-col sm:pb-[10px] text-[14px] gap-[6PX]">
                <p>{t("doc1.p7")}</p>
